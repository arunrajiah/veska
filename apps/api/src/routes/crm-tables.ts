...
crmTablesRouter.get('/contacts', async (c) => {
  try {
    ...
    return handleRouteError(c, err, 'GET /crm/contacts');
  }
});
...
crmTablesRouter.post('/contacts', async (c) => {
  try {
    ...
    return handleRouteError(c, err, 'POST /crm/contacts');
  }
});
...
crmTablesRouter.get('/contacts/:id', async (c) => {
  try {
    ...
    return handleRouteError(c, err, 'GET /crm/contacts/:id');
  }
});
...
crmTablesRouter.put('/contacts/:id', async (c) => {
  try {
    ...
    return handleRouteError(c, err, 'PUT /crm/contacts/:id');
  }
});
...
crmTablesRouter.delete('/contacts/:id', async (c) => {
  try {
    ...
    return handleRouteError(c, err, 'DELETE /crm/contacts/:id');
  }
});
...
crmTablesRouter.get('/stages', async (c) => {
  try {
    ...
    return handleRouteError(c, err, 'GET /crm/stages');
  }
});
...
crmTablesRouter.post('/stages', async (c) => {
  try {
    ...
    return handleRouteError(c, err, 'POST /crm/stages');
  }
});
...
crmTablesRouter.put('/stages/:id', async (c) => {
  try {
    ...
    return handleRouteError(c, err, 'PUT /crm/stages/:id');
  }
});
...
crmTablesRouter.delete('/stages/:id', async (c) => {
  try {
    ...
    return handleRouteError(c, err, 'DELETE /crm/stages/:id');
  }
});
...
crmTablesRouter.post('/stages/seed', async (c) => {
  try {
    ...
    return handleRouteError(c, err, 'POST /crm/stages/seed');
  }
});
...
crmTablesRouter.get('/deals', async (c) => {
  try {
    ...
    return handleRouteError(c, err, 'GET /crm/deals');
  }
});
...
crmTablesRouter.post('/deals', async (c) => {
  try {
    ...
    return handleRouteError(c, err, 'POST /crm/deals');
  }
});
...
crmTablesRouter.get('/deals/:id', async (c) => {
  try {
    ...
    return handleRouteError(c, err, 'GET /crm/deals/:id');
  }
});
...
crmTablesRouter.put('/deals/:id', async (c) => {
  try {
    ...
    return handleRouteError(c, err, 'PUT /crm/deals/:id');
  }
});
...
crmTablesRouter.delete('/deals/:id', async (c) => {
  try {
    ...
    return handleRouteError(c, err, 'DELETE /crm/deals/:id');
  }
});
...
crmTablesRouter.get('/pipeline', async (c) => {
  try {
    ...
    return handleRouteError(c, err, 'GET /crm/pipeline');
  }
});
