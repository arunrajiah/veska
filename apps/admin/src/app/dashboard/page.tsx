...
export default async function DashboardOverviewPage() {
  ...
  const originalStats = {
    totalPaidThisMonth: s?.finance.totalPaidThisMonth ?? 0,
    totalOutstandingInvoices: s?.finance.totalOutstandingInvoices ?? 0,
    totalExpensesPending: s?.finance.totalExpensesPending ?? 0,
    openDealsValue: s?.sales.openDealsValue ?? 0,
    totalInventoryValue: s?.inventory.totalInventoryValue ?? 0,
  };

  return (
    <DashboardClientCurrency originalStats={originalStats}>
      {({ currency, converted, currencySelector }) => (
        <div className="px-4 sm:px-6 py-6 sm:py-8 max-w-screen-xl mx-auto space-y-6">
          ...
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div className="flex flex-wrap items-baseline gap-2">
              <h1 className="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-gray-100">{t('welcome')}, Veska Admin</h1>
            ...
            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl px-5 py-4 flex items-center gap-3 flex-1">
              ...
              <div>
                <p className="text-lg font-semibold text-gray-900 dark:text-gray-100">
                  {s ? new Intl.NumberFormat('en-US', { style: 'currency', currency, notation: 'compact' }).format(converted.totalOutstandingInvoices) : dash}
                </p>
              ...
              <section>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <KpiCard
                    ...
                    value={s ? new Intl.NumberFormat('en-US', { style: 'currency', currency, notation: 'compact' }).format(converted.totalPaidThisMonth) : dash}
                    valueColor="text-green-600"
                  />
                  <KpiCard
                    label="Outstanding"
                    value={s ? new Intl.NumberFormat('en-US', { style: 'currency', currency, notation: 'compact' }).format(converted.totalOutstandingInvoices) : dash}
                    valueColor={s && s.finance.totalOutstandingInvoices > 0 ? 'text-amber-600' : undefined}
                  />
                  <KpiCard
                    label="Pending Expenses"
                    value={s ? new Intl.NumberFormat('en-US', { style: 'currency', currency, notation: 'compact' }).format(converted.totalExpensesPending) : dash}
                  />
                  <KpiCard
              ...
              <section>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <KpiCard
                    ...
                    value={s ? new Intl.NumberFormat('en-US', { style: 'currency', currency, notation: 'compact' }).format(converted.openDealsValue) : dash}
                  />
                </div>
              </section>
              ...
              <section>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <KpiCard
                    ...
                    value={s ? new Intl.NumberFormat('en-US', { style: 'currency', currency, notation: 'compact' }).format(converted.totalInventoryValue) : dash}
                  />
                  <KpiCard
