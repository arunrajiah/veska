...
export default async function ContactsPage() {
  ...
  try {
    const res = await apiFetch<ContactRecord[]>('/api/v1/crm/contacts', tenantId);
    ...
    <div className="px-8 py-8 max-w-5xl">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">{records.length} contacts</p>
        </div>
        <Link
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-right">
                      <Link
                        href={`/dashboard/crm/contacts/${record.id}`}
